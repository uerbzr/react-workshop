...
function VehicleLikeComponent(props) {
    const [activeVehicle, setActiveVehicle] = useState(-1)
    const LikeVehicle = (id,v) => {
        console.log(id,v)
        const items = props.vehicles
        items.find(x => x.id===id).likes += v      
        console.log(items)
        const newItems = items

        props.setVehicles(items)

    }

  return (
    <>
         <h1>{props.title ? props.title : 'Vehicle'} Like Component</h1>
...
export default VehicleLikeComponent